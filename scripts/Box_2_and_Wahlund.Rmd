...
PB <-  ggdraw() +
  draw_plot(demo_plot) +
  draw_plot(sfs_netural, x = .2, y = .279, width = inset_size, height = inset_size/1.2) +
  draw_plot(sfs_bottle, x = .64, y = .205, width = inset_size, height = inset_size/1.2) +
  draw_plot(sfs_expansion, x = .64, y = .68, width = inset_size, height = inset_size/1.2)
