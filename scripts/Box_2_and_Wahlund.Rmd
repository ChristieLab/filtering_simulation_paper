...
3. `structure_for_box_2.R`: Will run STRUCTURE on the monarch data for $k = 3$ with MAC filters of 2-11. Note it does so on a subset of 3819 SNPs to be equivalent to [Linik and Battey 2019](https://doi.org/10.1111/1755-0998.12995).
